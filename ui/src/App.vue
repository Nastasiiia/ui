<template>
  ...
  <h1 style="font-size:4rem; text-shadow: 2px 2px #fd6e00;">Food_Delievery🍟🍒🥵</h1>
...
html, body {
  ...
  background-image: url("https://expertphotography.b-cdn.net/wp-content/uploads/2019/02/food-photography-examples-8.jpg");
}
button{
  color: #465f7c;
